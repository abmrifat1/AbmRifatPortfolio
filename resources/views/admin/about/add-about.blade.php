             ...
             <div class="row">
                <div class="col-md-8 col-sm-offset-2">
                        ...
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title text-center text-success">Add About</h3>
                        </div>
                        <div class="panel-body">


                            <form role="form" action="{{url('/new-about')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="profession" class="form-control" id="inputEmail3" placeholder="profession">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="work_title" class="form-control" id="inputEmail3" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control textarea" name="work_description" rows="10"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="experience_title" class="form-control" id="inputEmail3" placeholder="profession">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control textarea" name="experience_description" rows="10"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="education_title" class="form-control" id="inputEmail3" placeholder="profession">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control textarea" name="education_description" rows="10"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="achivement_title" class="form-control" id="inputEmail3" placeholder="profession">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control textarea" name="achivement_description" rows="10"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="address" class="form-control" id="inputEmail3" placeholder="profession">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="phone_number" class="form-control" id="inputEmail3" placeholder="Brand Name">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="web_site" class="form-control" id="inputEmail3" placeholder="profession">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9">
                                        <button type="submit" name="btn" class="btn btn-success btn-block" value="Save About Info">Save Product Info</button>
                                    </div>
                                </div>
                            </form>
